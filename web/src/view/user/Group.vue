    ...
    <div>
        <el-card shadow="never">
            <el-row class="app-btn-group">
                <el-col :span="4">
                    <el-button @click="openAddDialogHandler" type="primary" size="medium" icon="iconfont left small icon-add">{{ $t('add_role') }}</el-button>
                </el-col>
        ...
        <el-dialog width="750px" :title="dialogTitle" :visible.sync="dialogVisible" @close="dialogCloseHandler">
